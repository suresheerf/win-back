...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<div class =\"alert alert-".concat(type, "\"><h3>").concat(msg, "</h3></div>");
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'login success');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'signup success');
              window.setTimeout(function () {
                location.assign('/');
              }, 5000);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"createCourse.js":[function(require,module,exports) {
"use strict";
...
var createCourse = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(course) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'New course created');
              window.setTimeout(function () {
  ...
  return function createCourse(_x) {
    return _ref.apply(this, arguments);
  };
}();
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            res = _context.sent;
            msg = type === 'password' ? 'password updated' : 'DATA updated';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Password reset link sent');
              window.setTimeout(function () {
...
var resetPassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(password, confirmPassword) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api".concat(window.location.pathname),
              data: {
                password: password,
                confirmPassword: confirmPassword
              }
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Password reset success');
              window.setTimeout(function () {
                location.assign('/login');
              }, 5000);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"notification.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.removeNotification = exports.createNotification = void 0;
...
var createNotification = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(title, notification) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'notification created successfuly');
              window.setTimeout(function () {
                location.assign('/');
              }, 5000);
            }
...
var removeNotification = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'notification deleted successfuly');
              window.setTimeout(function () {
                location.assign('/');
              }, 5000);
            }
  ...
  return function removeNotification(_x3) {
    return _ref2.apply(this, arguments);
  };
}();
...
var createNoteForm;
var createCourseForm = document.querySelector('.createCourseForm');
var userDetailsForm = document.querySelector('.userDetailsForm');
...
var btnAddNotification = document.querySelector('.btnAddNotification');
var btnCreateNotification = document.querySelector('.btnCreateNotification');
var btnDeleteNotification = document.querySelectorAll('.btnDeleteNotification'); // const detailsBtn = document.querySelector('.datails');
  ...
  btnAddNotification.addEventListener('click', function () {
    ...
    if (createNoteForm) {
      ...
      createNoteForm.addEventListener('submit', function (e) {
        ...
        (0, _notification.createNotification)(title, notification);
      });
    }
  });
}
...
if (btnDeleteNotification) {
  btnDeleteNotification.forEach(function (x) {
    x.addEventListener('click', function () {
      (0, _notification.removeNotification)(x.id);
    });
  });
}
...
if (createCourseForm) {
  var wnumber = 1;
  var lnumber = 1;
  var addweek = document.querySelector('.addweek');
  addweek.addEventListener('click', function () {
    var weekTemp = " <h6> week ".concat(wnumber, "</h6>\n                          <input class=\"form-control\" type=\"text\" placeholder=\"week\" id=\"week").concat(wnumber, "\"/>\n                          <br/>\n                          <input class=\"form-control\" type=\"text-area\" placeholder=\"week description\" id=\"wdescription").concat(wnumber, "\"/>\"\n                          <br/>\n                          <h6>lessons</h6>\n                          <input class=\"form-control\" type=\"text\" placeholder=\"lesson name\" id=\"lnameundefined\"/>\n                          <br/>\n                          <input class=\"form-control\" type=\"url\" name=\"llink\" placeholder=\"lesson link\" id=\"llinkundefined\"/>\n                          <button class=\"btn addlesson").concat(lnumber, "\">add lesson</button>");
  ...
  createCourseForm.addEventListener('submit', function (e) {
    ...
    var wdescription = document.getElementById('wdescription').value;
    ...
    (0, _createCourse.createCourse)(course);
  });
}
