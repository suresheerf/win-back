...
var showAlert = function showAlert(type, msg) {
  ...
  window.setTimeout(hideAlert, 1300);
};
...
var changePasswordForm = document.querySelector('.changePasswordForm'); // const detailsBtn = document.querySelector('.datails');
